/**
 * Created by lengdabao<lengdabao@dodoca.net> on 2015/9/24.
 */
(function (window, undefined) {
    ...
    K.options = {
        ...
        minChangeSize: 50,
        zIndex: 811213,
        items: ["source", "undo", "redo", "|", "justifyleft", "justifycenter", "justifyright", "justifyfull", "clearhtml", "fontsize", "forecolor", "bold", "italic", "underline", "link", "unlink", "|", "image", "flash", "fullscreen"],
                    ...
                    if (node.nodeType == 1) {
                        ...
                        if (node.nodeType == 3) {
                            ...
                            if (node == copyRange.startContainer) {
                                ...
                                if (node == copyRange.endContainer) {
    ...
    _extend(KRange, {
        ...
        createBookmark: function (serialize) {
            var self = this,
                doc = self.doc,
                endNode, startNode = K('<span style="display:none;"></span>', doc)[0];
    ...
    _extend(KEdit, KWidget, {
        init: function (options) {
            ...
            var themesPath = _undef(options.themesPath, ""),
                ...
                srcScript = ("document.open();" + (isDocumentDomain ? 'document.domain="' + document.domain + '";' : "") + "document.close();"),
    ...
    _plugin("core", function (K) {
        ...
        self.afterCreate(function () {
            var doc = self.edit.doc,
                cmd, bookmark, div, cls = "__kindeditor_paste__",
                pasting = false;
