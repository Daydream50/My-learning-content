...
if(!empty($_POST['username']))
{
    ...
    $sql = "select count('id') as total from `im_users` where username = '{$username}'";
   ...
   $sql = "insert into `im_users` (username,password,create_time) values
